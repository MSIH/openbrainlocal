...
// Writes { companyKind, humanKind, migRows } as JSON to the file at argv[3] — NOT stdout, which
// db.js pollutes with a startup log line — so the test can diff state across opens.
...
writeFileSync(process.argv[3], JSON.stringify({ companyKind, humanKind, migRows }));
db.close();
